...
const providerNamesOfTab: Record<TabName, ProviderName[]> = {
	Free: ['opencode', 'gemini', 'openRouter'],
	Local: localProviderNames,
	Paid: providerNames.filter(pn => !(['opencode', 'gemini', 'openRouter', ...localProviderNames, ...cloudProviders] as string[]).includes(pn)) as ProviderName[],
